...
public class ApiDataRestEntityTest {
    ...
    void generateRestRequest_didSucceed() throws JsonProcessingException {
        ...
        assertEquals( "{\"data\":{\"id\":\"name\",\"type\":\"api:element\",\"attributes\":{\"name\":\"name\",\"codeRepository\":\"codeRepository\"}}}", objectMapper.writeValueAsString(new JsonApiRestRequestWrapper<DataRestEntity>(object)));
    }
    ...
    void generatedRestResponse_didSucceed() throws JsonProcessingException, URISyntaxException {
        ApiDataRestEntity object = new ApiDataRestEntity(
                new ApiDataMetadataEntity("token"),
                "name",
                "codeRepository",
        ...
        ObjectMapper objectMapper = new ObjectMapper();
        assertEquals( "{\"data\":{\"id\":\"name\",\"type\":\"api:element\",\"attributes\":{\"name\":\"name\",\"codeRepository\":\"codeRepository\"},\"links\":{\"self\":\"http://localhost:8080\"},\"meta\":{\"token\":\"token\"}},\"links\":{},\"meta\":{},\"jsonapi\":{\"version\":\"1.1\"}}", objectMapper.writeValueAsString(new JsonApiRestResponseWrapper<DataRestEntity>(object)));
    }
