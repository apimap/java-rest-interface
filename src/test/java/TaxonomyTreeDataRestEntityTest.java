...
public class TaxonomyTreeDataRestEntityTest {
    ...
    void enumToString_didSucceed() throws JsonProcessingException {
        ...
        ObjectMapper objectMapper = new ObjectMapper();
        assertEquals( "{\"data\":{\"type\":\"urn:element\",\"attributes\":{\"urn\":null,\"title\":null,\"url\":null,\"description\":null,\"type\":\"reference\",\"entities\":[]},\"links\":{\"self\":null}},\"links\":{},\"meta\":{},\"jsonapi\":{\"version\":\"1.1\"}}", objectMapper.writeValueAsString(new JsonApiRestResponseWrapper<TaxonomyDataRestEntity>(object)));
    }
