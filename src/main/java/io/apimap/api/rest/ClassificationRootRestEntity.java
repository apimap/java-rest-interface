...
public class ClassificationRootRestEntity extends RootRestEntity {
    ...
    protected List<ClassificationDataRestEntity> data = new ArrayList<>();

    public ClassificationRootRestEntity() {
    }

    @JsonCreator
    public ClassificationRootRestEntity(List<ClassificationDataRestEntity> data) {
        this.data = new ArrayList<>(data);
    }

    public List<ClassificationDataRestEntity> getData() {
